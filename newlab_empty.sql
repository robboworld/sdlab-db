...
CREATE TABLE setups (id integer primary key, master_exp_id integer, session_key text, title text, interval integer, amount integer DEFAULT NULL, time_det integer DEFAULT NULL, period integer DEFAULT NULL, number_error integer DEFAULT NULL, period_repeated_det integer DEFAULT NULL, flag integer, FOREIGN KEY(master_exp_id) REFERENCES experiments(id), FOREIGN KEY(session_key) REFERENCES sessions(session_key));
